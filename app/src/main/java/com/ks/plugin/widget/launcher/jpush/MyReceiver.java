package com.ks.plugin.widget.launcher.jpush;
...
import com.ks.plugin.widget.launcher.MainActivity;
...
public class MyReceiver extends BroadcastReceiver {
    public static LinkedBlockingQueue<Map<String, String>> mapQueues = new LinkedBlockingQueue<Map<String, String>>();
    ...
    private void processCustomMessage(Context context, Bundle bundle) {
        ...
        Map<String, String> map = new Gson().fromJson(message, t);
        try {
            mapQueues.put(map);
        } catch (InterruptedException e) {
            e.printStackTrace();
        }
        WxHelper.shareToFriend(context, map.get("phone"), map.get("msg"));
